...
This is a web application that utilizes Next.js for the front-end and NestJS for the back-end. The front-end code is located in the `web/` folder, while the back-end code resides in the `api/` folder. The project is configured to use a MySQL database, which is set up and managed through the `docker-compose.yml` file for development.
